...
<div class="layui-layout layui-layout-admin  " >
    ...
    <div class="layui-body" >
        ...
        <div class="layui-col-md6" id="main" style="width: 700px;height:720px;">
        ...
        <script type="text/javascript">
                            ...
                            series: [
                                {
                                    ...
                                    data: [
                                        { value: cod[0], name: sed[0] },
                                        { value: cod[1], name: sed[1] }
            ...
            <div class="layui-col-md6" id="main1" style="width: 600px;height:720px;"></div>
            <script src="jquery-3.7.1.min.js"></script>
            <script type="text/javascript">
                $(function () {
                    $.ajax({
...
<%--        </div>--%>
        <div class="layui-row">
            <div class="layui-col-md6"><h3>收入大于50K</h3></div>
            <div class="layui-col-md6"><h3>收入小于50K</h3></div>
        </div>
