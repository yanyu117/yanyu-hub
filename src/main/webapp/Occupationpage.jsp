...
<div class="layui-layout layui-layout-admin  " >
    ...
    <div class="layui-body" >
        ...
        <div class="layui-col-md6" id="main1" style="width: 600px;height:520px;"></div>
        <script src="jquery-3.7.1.min.js"></script>
                                    ...
                                    option = {
                                        ...
                                        radar: {
                                            ...
                                            indicator: [
                                                ...
                                                { name: occ[8], max: 5500 },
                                                { name: occ[9], max: 5500 },
                                                { name: occ[10], max: 5500 },
                                                { name: occ[11], max: 5500 },
                                                { name: occ[12], max: 5500 },
                                                { name: occ[13], max: 5500 }
