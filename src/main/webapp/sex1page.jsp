...
<div class="layui-layout layui-layout-admin  " >
    ...
    <div class="layui-side ">
        <div class="layui-side-scroll " style="background-color: black">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test" >
                ...
                <li class="layui-nav-item layui-nav-itemed"><a href="javascript:;" style="background-color: black">性别情况 </a>
    ...
    <div class="layui-body" >
        <div class="layui-row">
            ...
            <div class="layui-col-md6" id="main" style="width: 650px;height:720px;">
                                            ...
                                            series: [
                                                {
                                                    ...
                                                    data: [
                                                        { value: cod[0], name: ind[0]},
                                                        { value: cod1[0], name: ind1[1] }
            ...
            <div class="layui-col-md6" id="main1" style="width: 650px;height:720px;"></div>
            <script src="jquery-3.7.1.min.js"></script>
            <script type="text/javascript">
                $(function () {
                    $.ajax({
                                ...
                                series: [
                                    {
                                        ...
                                        data: [
                                            { value: cod[1], name: ind[0]},
                                            { value: cod1[1], name: ind1[1] }
        ...
        <%--        </div>--%>
        <div class="layui-row">
            <div class="layui-col-md6"><h3>女性</h3></div>
            <div class="layui-col-md6"><h3>男性</h3></div>
        </div>
